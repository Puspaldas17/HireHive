...
export function NotesSection({ notes, onAddNote, isLoading = false }: NotesSectionProps) {
          ...
          notes.map((note) => (
            <div key={note.id} className="p-4 border border-border rounded-lg">
              <div className="flex items-start justify-between mb-2">
                <span className={`text-xs font-medium px-2 py-1 rounded ${getNoteTypeBadgeColor(note.type)}`}>
